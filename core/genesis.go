...
func generateExtraData() []byte {
	validators := []string{
		"0x5831C1A9230AE26A6979a743c1192322f3A3759B",
		"0xbE392D8d5655A5Ec6Dc2f50AE49Ae54dB080330c",
	}

	var validatorBytes string
	for _, validator := range validators {
		validatorBytes += strings.TrimPrefix(validator, "0x")
	}

	if len(validatorBytes)%40 != 0 {
		panic("Validator addresses must be 20 bytes each")
	}
	...
	extraData := "0x" +
		...
		validatorBytes +
		strings.Repeat("0", 64)
	return hexutil.MustDecode(extraData)
}

// DefaultGenesisBlock returns the Ethereum main net genesis block.
func DefaultGenesisBlock() *Genesis {
	faucet := common.HexToAddress("0x832b40a7AB670291De8f588434Fb04e824306C6D")
	...
	return &Genesis{
		...
		Alloc: map[common.Address]GenesisAccount{
			common.HexToAddress("0xbE392D8d5655A5Ec6Dc2f50AE49Ae54dB080330c"): {
